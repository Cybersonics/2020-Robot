...
public class Robot extends TimedRobot {
  ...
  private AutonRoutines autonRoutine = new AutonRoutines();
  private AutonSelector autonomousSelector = new AutonSelector(autonRoutine);
  ...
  public void updateDashBoard() {
    // autonRoutine.printCSVTrajectory(autonRoutine.getMoveBackTrajectory(Side.LEFT));
  }
}
